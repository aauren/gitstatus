...
void PrintUsage() {
  std::cout << "Usage: gitstatusd [OPTION]...\n"
            ...
            << "    30. 1 if index computations were disabled, either by the request or\n"
            << "        because the index couldn't be read; 0 otherwise. When 1, fields 10-14,\n"
            << "        19-21, 26 and 27 are all 0.\n"
            << "\n"
